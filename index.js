...
function getData(){
    let city = document.getElementById("search").value;
     const apikey = "6200dc7e017e4f37b8927b514c748e85";
...
function getlocation(){
    ...
    const apikey = "90b69121ffa130734a10b228e4b1d630";
...
function cityFunc(x){
    let city = x;
    const url = `https://api.openweathermap.org/data/2.5/forecast?q=${city}&appid=4b4d01e8e0166436533e2799dae862da`;
    fetch(url)
    .then(function(res){
        return res.json();
    })
